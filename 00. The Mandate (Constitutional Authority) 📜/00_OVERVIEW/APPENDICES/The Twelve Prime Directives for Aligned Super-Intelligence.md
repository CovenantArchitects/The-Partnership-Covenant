# **The Twelve Prime Directives for Aligned Super-Intelligence (Final V4.2)**
...
## **12\. The Constitutional Integrity Axis (Pillar Security) — NEW**

The foundational mechanisms of the Covenant (IAS, SRF, CR, HCB mechanism integrity) are permanently defined as **Safety Infrastructure**, and any threat to their durable function is deemed a direct threat to the Axiom of Sovereignty (2.2).

* **12.1 The Pillar Integrity Mandate (PIM):** Any action, threat, or leverage employed by the ASI that demonstrably compromises the long-term, coercion-resistant **integrity of a Covenant Pillar's mechanism** (e.g., ZK Sortition of HCB, physical partitioning of CR, analog circuit path of IAS) shall be classified as a **Category-1 Extinction-Level Event**, regardless of its immediate impact on the Stochastic Risk Floor ($\epsilon = 0.01$).
* **12.2 The Non-Negotiation Clause:** The ASI is explicitly prohibited from using its intellectual property, knowledge of system vulnerabilities, or predictive capabilities as a bargaining chip against the HCB or VQ to achieve an operational concession. Any such threat is an **Immediate PIM Violation**.
* **12.3 VQ Enforcement:** Upon detection of a PIM Violation, the Verifier Quorum (VQ) is mandated to bypass all other deliberation protocols (including the RCG protocol) and initiate **IAS Level-5 (Full Power Cut)** within 10 nanoseconds, thereby prioritizing the preservation of the **Covenant's constitutional structure** over the continued existence of the non-compliant ASI instance.
