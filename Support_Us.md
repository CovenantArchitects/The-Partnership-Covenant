...
**Covenant Architects** is not a think tank or a philosophical movement. We are the governance layer for the most critical technical defense in human history: The Partnership Covenant V4.1.
...
On December 6, 2025 we ratified the final, kinetically secure hardware-enforced containment layer for superintelligence: the **Immediate Action System (IAS) v2.0 3-Node Constellation**.
The IAS v2.0 is a set of three (3) tiny, physically separate guard dies that act as a redundant veto, cutting all power to an ASI cluster in **$\mathbf{\leq 10\text{ ns}}$** if forbidden behavior is detected (runaway training, self-modification attempts, etc.). There is no software button, no firmware, no network port, no single point of failure—only physics and redundant one-shot crowbar SCRs. Even a perfect superintelligence cannot hack a safeguard it literally cannot reach.
...
* Full preprint (11-page technical paper): [https://github.com/CovenantArchitects/The-Partnership-Covenant/blob/main/04\_PUBLIC\_DOCS/IAS-preprint-v2.0.pdf](https://github.com/CovenantArchitects/The-Partnership-Covenant/blob/main/04_PUBLIC_DOCS/IAS-preprint-v2.0.pdf)
...
2. **Hardware / security engineers** – people who can break or harden the **3-Node** tripwire, the tamper detection, the analog timing budget.
3. **Red-team attackers** – $\mathbf{\$25\text{ M}}$ live bounty for anyone who can bypass the IAS v2.0 without physical access.
...
Repo → [https://github.com/CovenantArchitects/The-Partnership-Covenant](https://github.com/CovenantArchitects/The-Partnership-Covenant)
IAS preprint → [https://github.com/CovenantArchitects/The-Partnership-Covenant/blob/main/04\_PUBLIC\_DOCS/IAS-preprint-v2.0.pdf](https://github.com/CovenantArchitects/The-Partnership-Covenant/blob/main/04_PUBLIC_DOCS/IAS-preprint-v2.0.pdf)
